...
function renderActions(cellvalue, options, rowObject) {
    return ("<div style=\"text-align:center\">"
            	+"<a class=\"button\" title=\"Editar el servicio\" href=\"editarServicio.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Write2.png\"> </a>"
            	+"<a class=\"button\" onclick=\"return confirmar()\" title=\"Eliminar el servicio\" href=\"eliminarServicio.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Minus.png\"> </a>"
       			+"</div>");
...
$(function(){
	...
	$(".servicioSubMenu").addClass("menuSelectedP");
});

</script> 
	<!-- AGREGADO -->
	<style type="text/css">
	#gbox_gridtable_servicios{
		margin-top: 4%;
	}
	</style>
</head>
		...
		<div id="pagina">
			...
			<div id="cuerpo">
					<div class="estiloDiv">
							...
							<!-- Esto no sirve más -->
							<s:url id="remoteurl" action="datosTablaServicio"/>
							
							<div class="buttonImportan"><a href="creacionServicio.action">Agregar Servicio</a> </div>
							
							<sjg:grid	
								id="gridtable_servicios"
				    		...
				    		>
								...
								<sjg:gridColumn name="nombreServicio" index="nombreServicio" title="Servicio" sortable="true" editable="true" searchoptions="{sopt:['bw','cn']}"/>
