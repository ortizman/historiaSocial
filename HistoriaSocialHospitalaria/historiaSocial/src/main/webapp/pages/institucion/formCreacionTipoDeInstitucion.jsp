...
<title>Formulario de alta - Nuevo Tipo De Instituci&oacute;n</title>
...
<% String user = (String)session.getAttribute("user"); 
	...
	<%} else { %>
		...
		<div id="dialog" style="display: none;">
		  <p>Primero debe registrar un ingreso antes de agregar un tipo de instituci&aacute;n</p>
		</div>	
		...
		<div id="pagina">
			<jsp:include page="../../header.jsp">
 			...
 			<div class="buttonReturn"><a href="institutionTypeIndex.action" > Volver </a></div>
    		
			<div id="tabs" style="font-size: 14px">
			    <ul>
			        <li><a href="#fragment-1"><span>Carga de Tipos De Instituciones</span></a></li>
			...
			<form	
			<s:if test="oper == 'edit'">	    
				 action="modificarTipoDeInstitucion.action"
			</s:if>
			<s:elseif test="oper == 'create'">
				action="salvarTipoDeInstitucion.action"
			</s:elseif>
			<s:else>
				action="salvarTipoDeInstitucion.action"
			</s:else>
			class="leftLabel" id="practica" method="post" name="Carga de Practica" target="_parent">
				...
				<div>
				<p>Nombre: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="institutionType.name" type="text" value="<s:property value="institutionType.name"/>" />
		
				<s:if test="oper == 'edit'">	    
					<input name="institutionType.id" type="hidden" value="<s:property value="institutionType.id"/>"/>
				</s:if>			
			    ...
			    <s:if test="oper == 'edit' || oper == 'create' || oper == ''">
					...
					<input name="submit" type="submit" value="Aceptar" />&nbsp; <input name="Cancelar" type="button" value="Cancelar" onclick="$(location).attr('href','institutionTypeIndex.action'); return false;" />
					</p>
				</s:if>
			</form>
