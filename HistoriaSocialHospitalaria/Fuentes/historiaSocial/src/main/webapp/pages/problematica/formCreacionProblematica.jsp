...
<title>Formulario de alta - Nueva Problem&aacute;tica</title>
...
<% String user = (String)session.getAttribute("user"); 
	...
	<%} else { %>
		...
		<div id="dialog" style="display: none;">
		  <p>Primero debe registrar un ingreso antes de agregar una problemática</p>
		</div>	
		...
		<div id="pagina">
			<jsp:include page="../../header.jsp">
 			...
 			<div class="buttonReturn"><a href="abmTipoProblematicas.action" > Volver </a></div>
    		
			<div id="tabs" style="font-size: 14px">
			    <ul>
			        <li><a href="#fragment-1"><span>Carga de Problem&aacute;ticas</span></a></li>
			...
			<form	
			<s:if test="oper == 'edit'">	    
				 action="modificarProblematica.action"
			</s:if>
			<s:elseif test="oper == 'create'">
				action="salvarProblematica.action"
			</s:elseif>
			<s:else>
				action="salvarProblematica.action"
			</s:else>
			class="leftLabel" id="practica" method="post" name="Carga de Practica" target="_parent">
				...
				<div>
				<p>C&oacute;digo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="tipoDeProblematica.codigo" type="text" value="<s:property value="tipoDeProblematica.codigo"/>" />	
				<p>Descripci&oacute;n: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="tipoDeProblematica.descripcion" type="text" value="<s:property value="tipoDeProblematica.descripcion"/>" />
				
				<s:if test="oper == 'edit'">	    
					<input name="tipoDeProblematica.id" type="hidden" value="<s:property value="tipoDeProblematica.id"/>"/>
				</s:if>			
			    ...
			    <s:if test="oper == 'edit' || oper == 'create' || oper == ''">
					...
					<input name="submit" type="submit" value="Aceptar" />&nbsp; <input name="Cancelar" type="button" value="Cancelar" onclick="$(location).attr('href','abmTipoProblematicas.action'); return false;"/>
					</p>
				</s:if>
			</form>
