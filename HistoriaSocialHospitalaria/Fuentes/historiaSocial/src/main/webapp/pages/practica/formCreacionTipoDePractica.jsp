...
<title>Formulario de alta - Nuevo Tipo De Pr&aacute;tica</title>
...
<% String user = (String)session.getAttribute("user"); 
	...
	<%} else { %>
		...
		<div id="dialog" style="display: none;">
		  <p>Primero debe registrar un ingreso antes de agregar un tipo de pr&aacute;ctica</p>
		</div>	
		...
		<div id="pagina">
			<jsp:include page="../../header.jsp">
 			...
 			<div class="buttonReturn"><a href="abmTipoPracticas.action" > Volver </a></div>
    		
			<div id="tabs" style="font-size: 14px">
			    <ul>
			        <li><a href="#fragment-1"><span>Carga de Tipos De Pr&aacute;cticas</span></a></li>
			...
			<form	
			<s:if test="oper == 'edit'">	    
				 action="modificarTipoDePractica.action"
			</s:if>
			<s:elseif test="oper == 'create'">
				action="salvarTipoDePractica.action"
			</s:elseif>
			<s:else>
				action="salvarTipoDePractica.action"
			</s:else>
			class="leftLabel" id="practica" method="post" name="Carga de Practica" target="_parent">
				...
				<div>
				<p>C&oacute;digo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="tipoDePractica.codigo" type="text" value="<s:property value="tipoDePractica.codigo"/>" />
				<p>Duraci&oacute;n: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="tipoDePractica.duracion" type="text" value="<s:property value="tipoDePractica.duracion"/>" />
				<p>Descripci&oacute;n:<textarea id="tipoDePractica.descripcion" name="tipoDePractica.descripcion" class="ckeditor"><s:property value="tipoDePractica.descripcion"/></textarea>

				<s:if test="oper == 'edit'">	    
					<input name="tipoDePractica.id" type="hidden" value="<s:property value="tipoDePractica.id"/>"/>
				</s:if>			
			    ...
			    <s:if test="oper == 'edit' || oper == 'create' || oper == ''">
					...
					<input name="submit" type="submit" value="Aceptar" />&nbsp; <input name="Cancelar" type="button" value="Cancelar" onclick="$(location).attr('href','abmTipoPracticas.action'); return false;"/>
					</p>
				</s:if>
			</form>
