...
<title>Listado de diagn&oacute;sticos m&eacute;dicos</title>
<!-- NUEVO -->
...
function renderActions(cellvalue, options, rowObject) {
    ...
    return ("<div style=\"text-align:center\">"
            	+"<a class=\"button\" title=\"Editar el diagn&oacute;stico\" href=\"editarDiagnostico.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Write2.png\"> </a>"
            	+"<a class=\"button\" onclick=\"return confirmar()\" title=\"Eliminar el diagn&oacute;stico\" href=\"eliminarDiagnostico.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Minus.png\"> </a>"
       			+"</div>");
...
$(function(){
	...
	$(".diagnosticoSubMenu").addClass("menuSelectedP");
});

</script> 
	<!-- AGREGADO -->
	<style type="text/css">
	#gbox_gridtable_diagnosticos{
	margin-top: 4%;
	}
	</style>
</head>
<body>
	...
	<%} else { %>
		<div id="pagina">
			...
			<div id="cuerpo">
					<div class="estiloDiv">
							<h3>Listado de Diagn&oacute;sticos</h3>
							<s:url id="remoteurl" action="datosTablaDiagnosticos"/>
							<s:url id="editurl" action="crudDiagnostico"/>
							<div class="buttonImportan">
							<a href="creacionDiagnostico.action">Agregar Diagn&oacute;stico</a> </div>
							
							<sjg:grid	
								id="gridtable_diagnosticos"
								caption="Diagnosticos"
								dataType="json"
								href="%{remoteurl}"
								pager="true"
								gridModel="diagnosticos"
								rowList="5,10,15,20"
								rowNum="10"
								rownumbers="true"
								autowidth="true"
							...
							>
								<sjg:gridColumn name="id" index="id" hidden="true" formatter="integer" title="ID Diagn&oacute;stico" sortable="true" editable="true" searchoptions="{sopt:['eq']}"/>
								<sjg:gridColumn name="diagnost" index="diagnost" title="Diagn&oacute;stico" sortable="true" editable="true" searchoptions="{sopt:['bw','cn']}"/>
