...
<title>Formulario de alta - Nueva Condici&oacute;n Habitacional</title>
	...
	<%} else { %>
		...
		<div id="pagina">
			<jsp:include page="../../header.jsp">
 			...
 			<div class="buttonReturn"><a href="abmCondicionHabitacional.action" > Volver </a></div>
    		
			<div id="tabs" style="font-size: 14px">
			    <ul>
			        <li><a href="#fragment-1"><span>Carga de Condici&oacute;n Habitacional</span></a></li>
			...
			<form	
			<s:if test="oper == 'edit'">	    
				 action="modificarCondicionHabitacional.action"
			</s:if>
			<s:elseif test="oper == 'create'">
				action="salvarCondicionHabitacional.action"
			</s:elseif>
			<s:else>
				action="salvarCondicionHabitacional.action"
			</s:else>
			class="leftLabel" id="creacion_condicionHabitacional" method="post" name="Nueva Condicion Habitacional" target="_parent">
			    <div id="fragment-1">
				<div>
					<s:textfield name="condicion" key="condicionHabitacional" label="Condición Habitacional" size="50" value="%{condicionHabitacional.condicion}"/>
			    ...
			    <s:if test="oper == 'edit' || oper == 'create' || oper == ''">
					...
					<input name="submit" type="submit" value="Aceptar" />&nbsp; <input name="Cancelar" type="button" value="Cancelar" onclick="$(location).attr('href','abmCondicionHabitacional.action'); return false;" />
					</p>
				</s:if>
			</form>
