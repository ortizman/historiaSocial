...
<title>ABM de Especialidades</title>
<!-- NUEVO -->
...
function renderActions(cellvalue, options, rowObject) {
    ...
    return ("<div style=\"text-align:center\">"
            	+"<a class=\"button\" title=\"Editar la especialidad\" href=\"editarEspecialidad.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Write2.png\"> </a>"
            	+"<a class=\"button\" onclick=\"return confirmar()\" title=\"Eliminar la especialidad\" href=\"eliminarEspecialidad.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Minus.png\"> </a>"
       			+"</div>");
...
$(function(){
	...
	$(".especialidadSubMenu").addClass("menuSelectedP");
});

</script> 
	<!-- AGREGADO -->
	<style type="text/css">
	#gbox_gridtable_especialidades{
	margin-top: 4%;
	}
	</style>
</head>
		...
		<div id="pagina">
			...
			<div id="cuerpo">
					<div class="estiloDiv">
							...
							<s:url id="remoteurl" action="datosTablaEspecialidades"/>
							<div class="buttonImportan"><a href="creacionEspecialidad.action">Agregar Especialidad</a> </div>
							
							<sjg:grid	
								id="gridtable_especialidades"
								caption="Especialidades"
								dataType="json"
								href="%{remoteurl}"
								pager="true"
								gridModel="especialidades"
								rowList="5,10,15,20"
								rowNum="5"
								rownumbers="true"
								autowidth="true"
							...
							>
								...
								<sjg:gridColumn name="descripcion" index="descripcion" title="Nombre Especialidad" sortable="true" editable="true" searchoptions="{sopt:['bw','cn']}"/>
