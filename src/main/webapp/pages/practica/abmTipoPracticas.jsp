...
<title>ABM Tipos de Pr&#225;cticas</title>
<!-- NUEVO -->
...
function renderActions(cellvalue, options, rowObject) {
    ...
    return ("<div style=\"text-align:center\">"
    			+"<a class=\"button\" title=\"Mostrar descripción\" href=\"visualizarTipoDePractica.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/ZoomIn.png\"> </a>"
            	+"<a class=\"button\" title=\"Editar el tipo de práctica \" href=\"editarTipoDePractica.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Write2.png\"> </a>"
            	+"<a class=\"button\" onclick=\"return confirmar()\" title=\"Eliminar el tipo de práctica\" href=\"eliminarTipoDePractica.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Minus.png\"> </a>"
       			+"</div>");
...
<% String user = (String)session.getAttribute("user"); 
	...
	<%} else { %>
		<div id="pagina">
			...
			<div id="cuerpo">
					<div class="estiloDiv">
							<h3>Tipo de Pr&aacute;cticas</h3>
							<s:url id="remoteurl" action="datosTablaTipoPracticas"/>
							<div class="buttonImportan"><a href="creacionTipoDePractica.action">Agregar Tipo De Pr&aacute;ctica</a> </div>
							
							<sjg:grid	
								id="gridtable_tipopracticas"
								caption="Tipo de Prácticas"
								dataType="json"
								href="%{remoteurl}"
								pager="true"
								gridModel="tipoPracticas"
								rowList="5,10,15,20"
								rowNum="5"
								rownumbers="true"
								autowidth="true"
							...
							>
								...
								<sjg:gridColumn name="codigo" index="codigo" title="Código" sortable="true" editable="true" searchoptions="{sopt:['bw','cn']}"/>
								<sjg:gridColumn name="duracion" index="duracion" title="Duración" sortable="true" editable="true" searchoptions="{sopt:['bw','cn']}"/>
