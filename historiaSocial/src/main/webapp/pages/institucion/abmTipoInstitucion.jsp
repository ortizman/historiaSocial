...
<title>Tipo Instituciones</title>
<!-- NUEVO -->
...
function renderActions(cellvalue, options, rowObject) {
    ...
    return ("<div style=\"text-align:center\">"
            	+"<a class=\"button\" title=\"Editar la institucion\" href=\"editarTipoDeInstitucion.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Write2.png\"> </a>"
            	+"<a class=\"button\" onclick=\"return confirmar()\" title=\"Eliminar el tipo de institución\" href=\"eliminarTipoDeInstitucion.action?id="+rowObject["id"]+"\"> <img src=\"images/16x16/Minus.png\"> </a>"
       			+"</div>");
...
<body>
	...
	<%} else { %>
		<div id="pagina">
			...
			<div id="cuerpo">
				<div class="estiloDiv">
				<h3>Listado de Tipos de Instituciones</h3>
					<s:url id="remoteurl" action="datosTablaTipoInstituciones"/>
					<div class="buttonImportan"><a href="creacionTipoDeInstitucion.action">Agregar Tipo de Instituci&oacute;n</a> </div>
				<sjg:grid	
								id="gridtable_instituciones"
								caption="Tipo Instituciones"
								dataType="json"
								href="%{remoteurl}"
								pager="true"
								gridModel="institutionTypes"
								rowList="5,10,15,20"
								rowNum="5"
								rownumbers="true"
								autowidth="true"
